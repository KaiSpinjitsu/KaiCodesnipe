...
BackgroundImage.Image = "rbxassetid://130855558398820"
...
BrandImage.Image = "rbxassetid://122749195297711"
BrandImage.ScaleType = Enum.ScaleType.Fit
BrandImage.Parent = BrandMark
addCorner(BrandImage, 15)

makeLabel(Header, "Title", "KAI CODE SNIPER", UDim2.fromOffset(180, 25), UDim2.fromOffset(56, 17), 15, COLORS.White, Enum.Font.GothamBold)
...
local DiscordFooter = makeLabel(Window, "DiscordFooter", "discord.gg/aJUP9ET4jK", UDim2.fromOffset(140, 19), UDim2.new(0.5, -70, 0, 346), 10, COLORS.White, Enum.Font.GothamBold)
...
-- ==============================================================================
-- WIDGET CENTRAL DE DISCORD (ACTUALIZADO CON TU ENLACE)
-- ==============================================================================
local success, err = pcall(function()
    local DiscordWidgetGui = Instance.new("ScreenGui")
    DiscordWidgetGui.Name = "DiscordWidgetGui"
    DiscordWidgetGui.ResetOnSpawn = false
    DiscordWidgetGui.IgnoreGuiInset = true
    DiscordWidgetGui.DisplayOrder = 1000
    
    if not pcall(function() DiscordWidgetGui.Parent = game.CoreGui end) then 
        DiscordWidgetGui.Parent = playerGui 
    end

    local DiscordWidgetFrame = Instance.new("Frame")
    DiscordWidgetFrame.Name = "DiscordWidgetFrame"
    DiscordWidgetFrame.Size = UDim2.fromOffset(210, 30)
    DiscordWidgetFrame.AnchorPoint = Vector2.new(0.5, 0.5)
    DiscordWidgetFrame.Position = UDim2.new(0.5, 0, 0.5, -120)
    DiscordWidgetFrame.BackgroundColor3 = COLORS.Window
    DiscordWidgetFrame.BackgroundTransparency = 0.25
    DiscordWidgetFrame.BorderSizePixel = 0
    DiscordWidgetFrame.Visible = true
    DiscordWidgetFrame.Parent = DiscordWidgetGui

    addCorner(DiscordWidgetFrame, 6)
    addStroke(DiscordWidgetFrame, COLORS.White, 1, 0.5)

    local DiscordWidgetText = Instance.new("TextLabel")
    DiscordWidgetText.Name = "DiscordLinkLabel"
    DiscordWidgetText.Size = UDim2.fromScale(1, 1)
    DiscordWidgetText.BackgroundTransparency = 1
    DiscordWidgetText.Text = "discord.gg/aJUP9ET4jK"
    DiscordWidgetText.TextColor3 = COLORS.White
    DiscordWidgetText.TextSize = 11
    DiscordWidgetText.Font = Enum.Font.GothamBold
    DiscordWidgetText.TextXAlignment = Enum.TextXAlignment.Center
    DiscordWidgetText.TextYAlignment = Enum.TextYAlignment.Center
    DiscordWidgetText.Visible = true
    DiscordWidgetText.Parent = DiscordWidgetFrame
end)

if not success then
    warn("Error al crear el widget de Discord: ", err)
end
